...
export default function App() {
  ...
  useEffect(() => {
  const csvUrl = `https://docs.google.com/spreadsheets/d/e/2PACX-1vR5Vevv1ci9XA4wljBXZ1_IR6LBFEIlXFF3wrotmGlreIi-cy3CTLhVOjo9qL6xtQqJBkzLYOgHZrmT/pub?gid=56442335&single=true&output=csv`;
